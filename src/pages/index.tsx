...
export default function Home() {
  return (
    <>
      <main className="text-color flex min-h-[calc(100vh-64px)] w-full flex-col bg-[url('/background.svg')] px-8 py-20 text-slate-800">
        <div className="min-h-screen bg-cover bg-center">
          <div className="container flex w-full flex-col gap-4 py-4">
            <div className="flex w-full flex-col items-center justify-center">
              <img src="/logo.svg" alt="" className="w-32" />
              <h1 className="scroll-m-20 text-center text-7xl font-extrabold tracking-tight lg:text-5xl">
                Coincidence
              </h1>
